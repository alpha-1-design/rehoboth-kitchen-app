...
const orderSchema = new mongoose.Schema({ userId: String, userName: String, userEmail: String, userPhone: String, items: Array, total: Number, status: { type: String, default: 'Pending' }, statusHistory: { type: Array, default: [] }, estimatedDelivery: String, region: String, ghanaPost: String, momoNumber: String, momoName: String, paymentMethod: String, createdAt: { type: Date, default: Date.now } });
